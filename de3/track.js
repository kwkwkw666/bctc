...
var initialSrc = "https://txpat.rdtk.io/"+campaignID+"?format=json";
...
setTimeout(function(){
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.querySelectorAll('a').forEach(function(el) {
                    if (el.href.indexOf("txpat.rdtk.io/click")>-1) {
                ...
                xhrr.open("GET", "https://txpat.rdtk.io/view?clickid="+rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://txpat.rdtk.io/view?clickid="+rtkClickID )
        xhrTrack.send();
        document.querySelectorAll('a').forEach(function(el) {
            if (el.href.indexOf("txpat.rdtk.io/click")>-1) {
                if (el.href.indexOf('?')>-1) {
